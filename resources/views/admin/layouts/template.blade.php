...
>
  <head>
    ...
    <title>backend - Analytics | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">EcomApp</span>
            </a>
    ...
    <!-- Page JS -->
    <script src="{{asset('backend/assets/js/backends-analytics.js')}}"></script>
